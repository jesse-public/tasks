...
module.exports = {
   ...
   */
  ssl: {
    ca: require('fs').readFileSync(require('path').resolve(__dirname, `../ssl/${process.env.CA_FILENAME}`)),
    cert: require('fs').readFileSync(require('path').resolve(__dirname,`../ssl/${process.env.CERT_FILENAME}`)),
    key: require('fs').readFileSync(require('path').resolve(__dirname,`../ssl/${process.env.KEY_FILENAME}`))
  },
